...
Define reusable endpoint-backed searchable select behavior for form controls that need async option loading, pagination, clear behavior, and selected-value display.
