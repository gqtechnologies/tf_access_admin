...
module BulkImportServices
  class ProcessPeopleImport
    ...
    # Partial import: a per-row failure does not stop the batch; final status
    # reflects imported/skipped/failed counts (completed_with_errors).
    def call
