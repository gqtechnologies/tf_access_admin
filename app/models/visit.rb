...
#  approved_by_id            :uuid
#  concierge_validated_by_id :uuid
...
# Indexes
#
#  index_visits_on_approved_by_id                        (approved_by_id)
#  index_visits_on_concierge_validated_by_id             (concierge_validated_by_id)
#  index_visits_on_created_by_person_id                  (created_by_person_id)
#  index_visits_on_created_by_user_id                    (created_by_user_id)
...
#  fk_rails_...  (concierge_validated_by_id => users.id)
